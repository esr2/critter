...
\small
	...
	\begin{tabular}{l p{9cm}}
		...
		neverUseCPlusPlusComments & Throw an error on C++ style single line comments. \\
		...
		isIfElsePlacementValid & Throw an error based on the placement of the else statement relative to the if statement.  \\
