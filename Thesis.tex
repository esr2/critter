...
very onerous. Most successful software companies employ a codified internal style but the task of 
enforcement falls to the employees. Most transgressions are simply due to inattention and could 
easily be solved by an automated reminder system. Such a tool would reduce the need to bother 
one's peers with simple style errors, allowing the entire team to be more productive. 

\todo{separate academia and industry and play up both -- successful?}
