...
\begin{figure}
\caption[Example PMD Rule]{Example PMD Rule}
\label{pmd-rule}
...
\end{lstlisting}
\small{This rule counts the number of expressions in the source code.}
\end{figure}
...
\begin{figure}
\caption[Example Checkstyle Check]{Example Checkstyle Check}
...
\end{lstlisting}
\small{This check counts the number of methods in a class.}
\end{figure}
...
\todo{add information of how to compile/install}
