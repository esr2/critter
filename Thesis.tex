...
\end{tabular}
\end{center}
\caption[Test Results for Magic Numbers]{Test Results for Magic Numbers. For this check, \programName had a recall of 83.6\% ($\frac{46}{46+9}$) and a precision of 80.7\% ($\frac{46}{46+11}$). \human had a recall of 60.0\% ($\frac{33}{33+22}$).}
...
which were called directly from the actions in the grammar (\autoref{1.0grammar}). Minimal comment 
tracking had been implemented inside the Checks module within a single function. Context was 
