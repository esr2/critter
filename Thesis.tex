...
errors. Some tools try to fill the stylistic error checking gap. Each approaches the problem differently, 
but all succeed in finding some stylistic errors. Three such tools are 
...
Splint displays warnings about basic stylistic errors like assignments with mismatched types and 
...
prevention and refactoring. These checks for correctness sometimes provide stylistic error checking as 
...
because they only work for Java, they do not satisfy my problem: stylistic error checking in C. In 
...
specified stylistic errors. It is run through the command line inside one's 
