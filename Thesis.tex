...
grammar (these possible constructions are known as a grammar rules). While parsing the code, 
\programname executes any function associated with the grammar rule. These functions are the 
checks which are stored in a different file (see \refCode \ref{grammar1.0}).
