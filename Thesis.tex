...
\todoin{add example for Checkstyle}
\nocite{framaC}
...
\todoin{reword so grammar points to grammar figure and then reference checks inside that figure which need to be boldfaced}
