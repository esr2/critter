...
Without extra information, Splint displays warnings about basic semantic errors like 
...
annotations are almost impossible to implement on top of learning to program. As 
