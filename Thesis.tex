...
files. These two elements combine into one larger program which takes a *.c file as input. 

To add a check, one must first figure out how the code in question is represented in the grammar. 
Then one adds a function call inside the appropriate grammar rule. When Bison 
