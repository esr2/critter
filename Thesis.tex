...
\section{Some Theory}
\todoin{Add information about grammar?, semantic values for terminals and AST/Visitor Pattern. Then go into why I didn't choose that route given SAX (ie lightweight, could read synchronously (maybe) instead of after reading the file).}
