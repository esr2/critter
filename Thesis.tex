...
evaluation, \programName proved to both helpful and reliable by increasing error detection by 16.3\% 
...
that is defined. \todo{AB more distinction from previous point?} Because of this disparity, Splint is limited to checking for commonly accepted errors but 
...
in the form of \lstinline{/*----*/} etc.) and if a comment contains a specificied string (with or without case 
sensitivity).
