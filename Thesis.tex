...
checks which are stored in a different file (see \refCode \ref{grammar1.0}). Additionally, checks can be 
called from the beginning or end of each file or the entire program.
