...
many expressions are in the source code (see \refCode \ref{pmd-rule}).\cite{pmd} \todoin{why PMD doesn't work}
...
selection_statement
	...
	| IF `(' expression `)' statement ELSE statement {$$ = IF_ELSE_SELECTION, ifHasBraces($5, @$);  ifHasBraces($7, @$);}
