...
enum_specifier
	...
	| ENUM IDENTIFIER {h_ignoreIdentifierText(@2);} '{' enumerator_list '}'
	| ENUM IDENTIFIER {h_ignoreIdentifierText(@2);}
	;
...
function_definition
	...
	| error declarator {h_beginFunctionDefinition(@2);} compound_statement {endFunctionDefinition(@$);}
	;
